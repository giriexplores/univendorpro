...
interface ProductCardProps {
  product: Product;
  addToCart: (product: Product, selectedColor: { name: string; hex: string; imageUrl: string } | null, selectedSize: string | null, goToCheckout?: boolean) => void;
}

export function ProductCard({ product, addToCart }: ProductCardProps) {
  const [hoverImage, setHoverImage] = useState<string | null>(null);
  const [selectedColor, setSelectedColor] = useState<{ name: string; hex: string; imageUrl: string } | null>(null);
  const [selectedSize, setSelectedSize] = useState<string | null>(null);

  const displayImage = hoverImage ? hoverImage : (selectedColor ? selectedColor.imageUrl : product.imageUrl);
