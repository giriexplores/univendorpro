      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            The complete multi-tenant eCommerce solution for businesses. Create
            your online store, manage products, and grow your business with our
            powerful platform.
          </p>
          <Button
            onClick={handleLogin}
          ...
          <Card className="text-center">
            <CardContent className="pt-6">
              ...
              <p className="text-gray-600">
                Create and manage multiple storefronts with custom domains and
                branding.
              </p>
            </CardContent>
          </Card>
