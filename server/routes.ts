...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.post("/api/auth/send-otp", async (req, res) => {
    try {
      ...
      console.log("OTP saved to database for email:", email, "expires at:", expiresAt, "otp: ", code);
  ...
  // Then apply vendor domain access check
  app.use("/api/products", async (req: any, res: any, next: any) => {
    ...
    // For localhost, handle product creation specially
    ...
    // For all other cases, use the standard domain check
